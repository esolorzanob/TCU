<div class="form_wrapper">
   ...
   <form name="formActivos" ng-controller="CrearController" role="form"
    ...
    <div class="form-group">
       <div class="col-md-3">
		 ...
		 <div class="col-md-3">
			 ...
			 <input id="fecha_factura" ng-model="activo.Fecha_Factura" tabindex="7" type="date" 
                        class="form-control">
    ...
    <div class="form-group">
        <div class="col-md-4">
            <button type="button" class="btn btn-primary" ng-click="guardar()" ng-show="authenticatedUser.Rol == 1">Guardar</button>
        </div>
    </div>
</form>
